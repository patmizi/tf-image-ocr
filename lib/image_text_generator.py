...
class TextImageGenerator(keras.callbacks.Callback):
    ...
    def get_output_size(self):
        return len(constants.ALPHABET) + 1
    ...
    def build_word_list(self, num_words, max_string_len=None, mono_fraction=0.5):
        ...
        with codecs.open(self.bigram_file, mode='r', encoding='utf-8') as f:
            ...
            for line in lines:
                ...
                if iutil.is_valid_str(word) and _is_length_of_word_valid(word):
                    tmp_string_list.append(word)
        if len(tmp_string_list) != self.num_words:
        ...
        for i, word in enumerate(self.string_list):
            ...
            self.Y_data[i, 0:len(word)] = iutil.text_to_labels(word)
    ...
    def next_train(self):
        while 1:
            ...
            if self.cur_train_index >= self.val_split:
                ...
                (self.X_text, self.Y_data, self.Y_len) = iutil.shuffle_mats_or_lists(
    ...
    def on_train_begin(self, logs={}):
        ...
        self.paint_func = lambda text: iutil.paint_text(
